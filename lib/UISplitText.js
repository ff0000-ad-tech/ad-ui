/** 
	...
	@param {arg} arg
		...
		@property {number} arg.wordSpacing
	...
	constructor(arg) {
		...
		switch (arg.format) {
			case TextFormat.PARAGRAPH:
				_newFormat = 'PARAGRAPH_CLAMP'
				break
			case TextFormat.PARAGRAPH_FIT:
				_newFormat = 'PARAGRAPH_FIT_CLAMP'
				break
			case TextFormat.INLINE:
				_newFormat = 'INLINE_CLAMP'
				break
			case TextFormat.INLINE_FIT:
				_newFormat = 'INLINE_FIT_CLAMP'
				break
		}
		arg.format = TextFormat[_newFormat]
		...
		var _spacing = _spaceText.width * (arg.wordSpacing || 1) //Math.ceil(_mainTF.fontSize / (3.7 / (arg.padding || arg.spacing || 1)));
