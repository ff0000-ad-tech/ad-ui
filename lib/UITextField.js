		...
		*/
		...
		function autoSizeContent() {
			...
			if (_format == 'paragraphFit') {
				...
				// console.log('>', _content.offsetWidth, _content.offsetHeight)
		...
		// var _tester = document.createElement('span')
		// Styles.addClass(_tester, 'content')
		// _tester.style.fontSize = '20px'
		// _tester.style.fontFamily = U.fontFamily
		// _tester.innerHTML = 'aA0.<span style="font-size:50%">aA0.</span>'
		// U.appendChild(_tester)
		// U.removeChild(_tester)
