...
function UISlider ( arg ){
	...
	/* ------------------------------------------------------------------------------------------------------------------------------- */
	// BASE CSS
	Styles.injectStylesheet ( 'RED_uiSlider', 
	...
	*/
	...
	function handleBaseEnabled ( event ){
		...
		GestureInstance[listener]( U.hitState, GestureEvent.RELEASE, handleUp );
		GestureInstance[listener]( U.hitState, GestureEvent.DRAG, handleDrag );
		GestureInstance[listener]( U.hitState, GestureEvent.CLICK, handleClick );
	}
