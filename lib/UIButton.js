...
function UIButton ( arg ){
	...
	*/
	...
	function handleBaseEnabled ( event ){
		var listener = U.enabled ? 'addEventListener' : 'removeEventListener' ;
		GestureInstance [ listener ]( U, GestureEvent.CLICK, handleClick );
		GestureInstance [ listener ]( U, GestureEvent.OVER, handleOver );
		GestureInstance [ listener ]( U, GestureEvent.OUT, handleOut );
	}
